<template>
    <div class="crib-indexlist">
        <div class="crib-indexlist-content" ref="content" :style="{ 'height': currentHeight + 'px'}">
            <slot></slot>
        </div>
        <div class="crib-indexlist-nav" @touchstart="handleTouchStart" ref="nav">
            <ul class="crib-indexlist-navlist">
                <li class="crib-indexlist-navitem" v-for="(nav,index) in navs" :style='navStyle'>{{nav}}</li>
            </ul>
        </div>
